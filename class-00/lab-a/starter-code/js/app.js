...
function displayPics(){
  ...
  //rando is undefined in above line because const rando is a scoped inside function block, which means only defined inside the above function.They are not defined outside that function. 
  console.log(viewed);
